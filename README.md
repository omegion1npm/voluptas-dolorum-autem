# @omegion1npm/voluptas-dolorum-autem
...
To report a bug or request a feature please open an issue or pull request in [GitHub](https://github.com/omegion1npm/voluptas-dolorum-autem). Please read the `Troublehsooting` section below *before* filing a bug.
...
```
$ npm install @omegion1npm/voluptas-dolorum-autem --save
```

In your project file:
```javascript
const urlMetadata = require('@omegion1npm/voluptas-dolorum-autem');

try {
  const url = 'https://www.npmjs.com/package/@omegion1npm/voluptas-dolorum-autem';
...
const options = {
  ...
  requestHeaders: {
    'User-Agent': '@omegion1npm/voluptas-dolorum-autem/3.0 (npm module)',
...
try {
  ...
  const response = await fetch('https://www.npmjs.com/package/@omegion1npm/voluptas-dolorum-autem');
